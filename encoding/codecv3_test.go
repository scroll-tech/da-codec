...
func TestCodecV3BlobEncodingAndHashing(t *testing.T) {
	...
	chunk2 := &Chunk{Blocks: []*Block{block2}}
	originalBatch := &Batch{Chunks: []*Chunk{chunk2}}
	batch, err := codecv3.NewDABatch(originalBatch)
	assert.NoError(t, err)
	...
	assert.Equal(t, common.HexToHash("0x01bbc6b98d7d3783730b6208afac839ad37dcf211b9d9e7c83a5f9d02125ddd7"), batch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x01fae670a781fb1ea366dad9c02caf4ea1de4f699214c8171f9219b0c72f6ad4"), batch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x012e15203534ae3f4cbe1b0f58fe6db6e5c29432115a8ece6ef5550bf2ffce4c"), batch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x015b4e3d3dcd64cc0eb6a5ad535d7a1844a8c4cdad366ec73557bcc533941370"), batch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x01fc79efca1213db1aa0183865b0a360dc152662cde34ee6a34e7607b96c1c89"), batch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x0128f90d5edbcb10d13521824ccc7f47f85aff6e2da01004f9a402854eb33632"), batch.(*daBatchV3).blobVersionedHash)
}
...
func TestCodecV3BatchStandardTestCases(t *testing.T) {
	...
	nRowsData := 5*maxEffectiveBlobBytes - (int(codecv3.MaxNumChunksPerBatch())*4 + 2)
	...
	for _, tc := range []struct {
		...
		blob, blobVersionedHash, z, _, err := codecv3.(*DACodecV3).constructBlobPayload(chunks, int(codecv3.MaxNumChunksPerBatch()), true /* use mock */)
